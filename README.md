...
Verified Search Pro 是一套面向深度调研和事实核查的可信研究 Skill。当前公开版本是 **v2.0.0-alpha.2**：用于公开试用 v2 evidence-pack workflow、跨 agent 适配和 benchmark 门禁，不标记为稳定生产版。v1.0.0 仍是稳定基线。
